...
Cuando la exportación se encuentre lista, se nos envía un email con un vínculo que nos permite descargar los archivos, el cúal va a estar disponible durante 48hs y luego es elíminado. 
...
me da la posibilidad de suscribirme al mismo, pudiendo programar la fecha que quiero que me llegue tanto a mi como a un conjunto de usuarios extras. :fire:
:::