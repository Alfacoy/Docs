...
Su función es la de procesar datos, coordina y controla el funcionamiento de los dispositivos y realiza operaciones lógicas y matemáticas.

Se los suele encontrar colocados en la **motherboard** sobre un elemento llamado **"zócalo"**.
