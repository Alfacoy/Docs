...
Gracias a esta configuración, tenemos la capacidad de redirigir la notificación de error de flujo a un usuario o grupo que hayamos configurado en [Email de excepción de Apex](../../dev/email).
